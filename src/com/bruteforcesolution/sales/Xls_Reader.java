...
public class Xls_Reader {
    ...
    FileOutputStream fileOut = new FileOutputStream("C:\\Excelf\\"+filename);
	...
	public boolean setHeader(String sheetName,int colNum,int rowNum, String data){
		try{
		fis = new FileInputStream(path); 
		workbook = new XSSFWorkbook(fis);
	...
	public boolean setResultData(String sheetName,int colNum,int rowNum, String data){
		try{
		fis = new FileInputStream(path); 
		workbook = new XSSFWorkbook(fis);
	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data,String url){
		...
		if (data.equalsIgnoreCase("pass")){
			hlink_style.setFillForegroundColor(IndexedColors.SEA_GREEN.getIndex());
